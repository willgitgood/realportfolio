...
const useTypingEffect = (phrases, initialTypingSpeed = 100, initialDeletingSpeed = 150) => {
    ...
    useEffect(() => {
        const handleTyping = () => {
            ...
            if (!isDeleting && text === currentPhrase) {
                ...
                setIsDeleting(false);
                setCurrentIndex((prevIndex) => (prevIndex + 1) % phrases.length); setTypingSpeed(typingSpeed);
            }
        };
